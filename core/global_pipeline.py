...
import visualization.global_visualizations as visualizations
...
def compute_xper_values_and_cluster(
    ...
    phi_global, phi_per_instance = xper_instance.calculate_XPER_values(["AUC"], kernel=KERNEL_USE, execution_type="ProcessPoolExecutor")
...
def evaluate_test_data_xper_clusters(X_test, y_test, xper_scaler, label_encoders):
    ...
    phi_global_test, phi_per_instance_test = xper_instance.calculate_XPER_values(["AUC"], kernel=KERNEL_USE, execution_type="ProcessPoolExecutor")
