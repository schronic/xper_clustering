...
import visualizations_cluster

# ============================================================================
# 2. ENVIRONMENT SETUP
# ============================================================================

experiment_folder = "experiment_results_18022025120717"
...
def apply_clustering_method(data: np.ndarray, method: str = "kmedoids", n_clusters: int = 3, random_state: int = 42):
    ...
    if method.lower() == "kmedoids":
        ...
        clustering_model = DBSCAN(eps=0.5, min_samples=8)
        labels = clustering_model.fit_predict(data)
        # TODO: dbscan and hierarchical dont work. for different reasons. "hierarchical" has no inherinent predict operator, and "dbscan" leads to outlier values
    else:
