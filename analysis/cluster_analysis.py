...
def load_experiment_data(exp_path, cluster):
    ...
    if os.path.exists(os.path.join(exp_path, 'xper_values', f"cluster_{cluster}_xper_train.csv")):
        ...
        phi_global_train, phi_per_instance_values = xper_instance.calculate_XPER_values(["AUC"], kernel=False, execution_type="ProcessPoolExecutor") #TODO: Load from config
    ...
    if os.path.exists(os.path.join(exp_path, 'xper_values', f"cluster_{cluster}_xper_test.csv")):
        ...
        phi_global_test, phi_per_instance_values = xper_instance.calculate_XPER_values(["AUC"], kernel=False, execution_type="ProcessPoolExecutor") #TODO: Load from config
